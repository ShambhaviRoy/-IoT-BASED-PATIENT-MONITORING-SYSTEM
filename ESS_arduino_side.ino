...
#include <dht.h>
const char *ssid =  "Isha";     // replace with your wifi ssid and wpa2 key
const char *pass =  "isha1998";
...
switch(chk) {
  ...
  delay(500);
    //critical situations-high/low body temp
    if (temp<32 || temp>38){
    Serial.println("Critical situation-high/low body temp");
...
if (QS == true){     // A Heartbeat Was Found
  Serial.println("BPM has been determined");
  Serial.print("BPM=");
